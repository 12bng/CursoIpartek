...
public class Lenguaje {
	...
	public static void main(String[] args) {
		...
		/*
		 * Tipos primitivos --------------------- ENTEROS CON SIGNO byte 8 -> Byte short
		 * 18 -> Short int 36 -> Integer long 64 -> Long
		 * 
		 * CON COMA float 32 -> Float double 64 -> Double
		 * 
		 * boolean 16 -> Boolean char 16 Unicode -> 'a' -> Character
		 * 
		 * 
		 */
