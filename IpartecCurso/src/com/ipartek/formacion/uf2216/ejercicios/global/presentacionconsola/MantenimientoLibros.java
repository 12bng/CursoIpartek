			...
			try {
				...
				// Modificar
					...
					for (Libro libro : dao.obtenerTodos()) {
						...
						pw.println((libro.getId() + "," + libro.getTitulo() + "," + libro.getISBN() + ","
								+ libro.getEditorial() + "," + libro.getAutor() + "," + libro.getDescripcion() + ","
								+ libro.getGenero() + "," + libro.getEdicion() + "," + libro.getFecha() + ","
								+ libro.isBorrado()));
					}
...
//									            }
							line = br.readLine();
							Libro nuevoLibro = new Libro(Integer.parseInt(fields[0]), fields[1], fields[2], fields[3],
